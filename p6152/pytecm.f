...
C...matrix for gamma, Z, technirho, and techniomega to optimize the
...
C...Local variables.
     ...
     &far,fao,fzr,fzo,shr,R1,R2,S1,S2,WDTP(0:200),WDTE(0:200,0:5)
      INTEGER i,j,ierr
      ...
      AR(3,3) = SH-PMAS(54,1)**2
      AR(4,4) = SH-PMAS(56,1)**2
      AR(1,2) = 0D0
      AR(2,1) = 0D0
      AR(1,3) = -SH*FAR
      AR(3,1) = AR(1,3)
