...
//root -l FFdrawDwa.C"(\"out.root\",\"out-ibox1.root\")"

void FFdrawDwa(TString fn0, TString fn1) 
{
...
//=========  (Tue Jun 19 11:28:36 2018) by ROOT version6.10/08
  ...
  TCanvas *c8 = new TCanvas("c8", "c8",771,496,700,500);
   ...
   TFile *_file0 = TFile::Open(fn0);   // tutaj
   ...
   TFile *_file1 = TFile::Open(fn1);   // otwieramy drugi plik

   TH1D *FFreM9_1 = (TH1D *)_file1->Get("FFreM9");
   TH1D *FFreM3_1 = (TH1D *)_file1->Get("FFreM3");
   TH1D *FFreM0_1 = (TH1D *)_file1->Get("FFreM0");
   TH1D *FFreP3_1 = (TH1D *)_file1->Get("FFreP3");
   TH1D *FFreP9_1 = (TH1D *)_file1->Get("FFreP9");

   TH1D *FFimM9_1 = (TH1D *)_file1->Get("FFimM9");
   TH1D *FFimM3_1 = (TH1D *)_file1->Get("FFimM3");
   TH1D *FFimM0_1 = (TH1D *)_file1->Get("FFimM0");
   TH1D *FFimP3_1 = (TH1D *)_file1->Get("FFimP3");
   TH1D *FFimP9_1 = (TH1D *)_file1->Get("FFimP9");

   TH1D *Sigo0_1 = (TH1D *)_file1->Get("Sigo0");
   TH1D *Sigo1_1 = (TH1D *)_file1->Get("Sigo1");
   TH1D *SigoR_1 = (TH1D*)Sigo1_1->Clone("SigoR");
   
   TH1D *Asym0_1 = (TH1D *)_file1->Get("Asym0");
   TH1D *Asym1_1 = (TH1D *)_file1->Get("Asym1");
   TH1D *AsymR_1 = (TH1D*)Asym1_1->Clone("Asym1_1");

    
   TH1D *Pol0_1 = (TH1D *)_file1->Get("Pol0");
   TH1D *Pol1_1 = (TH1D *)_file1->Get("Pol1");
   TH1D *PolR_1 = (TH1D*)Pol1_1->Clone("Pol1_1");
  
   //przykladowy rysunek dwoch na sobieSi
   //  FFreM9_1->Draw();
   // FFreM9->Draw("same");
   //   return;   // dalej sie nie wykonuje
   
   SigoR_1->Divide(Sigo1);
   AsymR_1->Add(Asym1,-1.0);
   PolR_1->Add(Pol1,-1.0);   
   ...
   Sigo0_1->SetLineColor(4);
   Sigo1_1->SetLineColor(6);

   Asym0->SetLineColor(1);
   Asym1->SetLineColor(2);
   
   Asym0_1->SetLineColor(4);
   Asym1_1->SetLineColor(6);

   Pol0->SetLineColor(1);
   Pol1->SetLineColor(2);
   
   Pol0_1->SetLineColor(4);
   Pol1_1->SetLineColor(6);
   ...
   FFreM9->SetMaximum(1.06);  // tutaj A
   FFreM9->SetMinimum(1.00);
   ...
   ll3->AddEntry(Sigo1,"as above");
   ll3->AddEntry(Sigo1_1,"ver 1");
   ll3->Draw();
   ...
   SigoR_1->Draw();
      ll4->AddEntry(Sigo0,"Ratio Sig_as-above/Sig_v0");
   ...
   c5->SetSelected(c5);
     ...
     Asym1->Draw();
     Asym1_1->Draw("same");
     ll5->AddEntry(Asym1,"A(FB) ver above");
     ll5->AddEntry(Asym1_1,"A(FB) ver 1");
   ...
   c6->SetSelected(c6);
     ...
     AsymR_1->Draw();
     //   Asym1->Draw("same");
        ll6->AddEntry(Asym0,"  Asym(as-above) - Asym_1(ver-0) ");
     ll6->Draw();   
   ...
   c7->SetSelected(c7);
     ...
     Pol1->Draw();
     Pol1_1->Draw("same");
     ll7->AddEntry(Pol1,"Pol as above");
     ll7->AddEntry(Pol1_1,"Pol ver 1");
   ...
   c8->SetSelected(c8);
     ...
     PolR_1->Draw();
     //   Asym1->Draw("same");
        ll8->AddEntry(Pol0,"  Pol(as-above) - Pol(ver-0) ");
     ll8->Draw();   
