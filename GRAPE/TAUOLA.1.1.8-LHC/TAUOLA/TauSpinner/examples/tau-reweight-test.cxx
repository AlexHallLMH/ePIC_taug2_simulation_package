...
void testEWcrude(){
  ...
  int NO=2;   //<<<<<<<<<<<<<<<<<<<
   ...
   for (int mode=0; mode<=1;mode++){
     ...
     cout <<"   ============   "<< endl;
     if(mode==0){SWeff=0.231499; //0.2315200;
       alfinv=128.950302244034418; //128.86674175;
       keyGSW=2;}
     //if(mode==1){SWeff=0.2315200; alfinv=128.86674175; keyGSW=2;}     
     if(mode==1){SWeff=0.223520000; alfinv=137.0359895;keyGSW=1;}
       cout << ",  keyGSW  =  "<<keyGSW;
       cout << ",  alfinv  =  "<<alfinv;
       cout << "   SWeff   =  "<<SWeff;
       cout <<" "<< endl;;
       double GAM=Gamz(FLAV);//2.49520000;
   ...
   int ID=JJ;
     for(int KK=0; KK<=4;KK++){
       ...
       cc= 0.5;// -0.33;
       si=sigbornswdelt(mode,ID, s, cc, SWeff, DeltSQ, DeltV, Gmu, alfinv, AMZ00,GAM,keyGSW);// /s*3.14*8./3.;
...
int main(int argc, char **argv) {
 ...
 //#############
  ...
  EWanomInit();
  // testEWcrude(); // crude print test, It modifies couplings
                    // similarly as initTables()
  //#############
