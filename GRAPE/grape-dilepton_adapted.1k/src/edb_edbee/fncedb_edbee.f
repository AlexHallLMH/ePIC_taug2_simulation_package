...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8 xx(mxdim),p(4,nedb_edbeeextn)
      real*8 pp(nedb_edbeeextn,nedb_edbeeextn)
...
*     1: initial d-bar mass=amdq(1)
      peedb_edbee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peedb_edbee2(i) = p(i, kperm(2))

*     3: final d-bar mass=amdq(1)
      peedb_edbee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peedb_edbee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peedb_edbee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peedb_edbee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nedb_edbeeextn
      do 30 i = 1, nedb_edbeeextn
...
*=======================================================================
      call kfill_4f(nedb_edbeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
