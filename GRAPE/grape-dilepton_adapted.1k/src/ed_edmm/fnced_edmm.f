...
*     1: initial d mass=amdq(1)
      peed_edmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peed_edmm2(i) = p(i, kperm(2))

*     3: final d mass=amdq(1)
      peed_edmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peed_edmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peed_edmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peed_edmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, ned_edmmextn
      do 30 i = 1, ned_edmmextn
...
*       ===================
        ...
        if (IBASES.EQ.0) then 
          call spstr4(kreg, ned_edmmextn, led_edmmag, ans, p, agc) 
        endif
...
*=======================================================================
      call kfill_4f(ned_edmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
...
*=======================================================================
 ...
 1000 continue 
      ...
      if (IBASES.EQ.0) then 
        call spput4(kreg, ned_edmmextn, led_edmmag, p, agc) 
      endif
