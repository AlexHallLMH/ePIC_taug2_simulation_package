...
* External lines
      call smextf(loutgo,amdq(3),pfebb_ebbmm2,
     &ptebb_ebbmm2u,cfebb_ebbmm2u)
      exebb_ebbmm2u(1) = lantip
      call smextf(loutgo,amlp(1),pfebb_ebbmm4,
     &ptebb_ebbmm4m,cfebb_ebbmm4m)
      exebb_ebbmm4m(1) = lantip
      call smextf(lincom,amdq(3),pfebb_ebbmm9,
     &ptebb_ebbmm9u,cfebb_ebbmm9u)
      exebb_ebbmm9u(1) = lantip
      call smextf(lincom,amlp(1),pfebb_ebbmm17,
     &ptebb_ebbmm17m,cfebb_ebbmm17m)
      exebb_ebbmm17m(1) = lantip
      call smextf(loutgo,amlp(2),pfebb_ebbmm33,
     &ptebb_ebbmm33n,cfebb_ebbmm33n)
      exebb_ebbmm33n(1) = lprtcl
      call smextf(lincom,amlp(2),pfebb_ebbmm62,
     &ptebb_ebbmm62n,cfebb_ebbmm62n)
