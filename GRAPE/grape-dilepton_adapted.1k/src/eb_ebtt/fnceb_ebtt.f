...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,neb_ebttextn),
     &pp(neb_ebttextn,neb_ebttextn)
...
*     1: initial b mass=amdq(3)
      peeb_ebtt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeb_ebtt2(i) = p(i, kperm(2))

*     3: final b mass=amdq(3)
      peeb_ebtt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeb_ebtt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peeb_ebtt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peeb_ebtt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neb_ebttextn
      do 30 i = 1, neb_ebttextn
...
*=======================================================================
      call kfill_4f(neb_ebttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
