...
* External lines
      call smextf(loutgo,amuq(2),pfecb_ecbmm2,
     &ptecb_ecbmm2q,cfecb_ecbmm2q)
      execb_ecbmm2q(1) = lantip
      call smextf(loutgo,amlp(1),pfecb_ecbmm4,
     &ptecb_ecbmm4m,cfecb_ecbmm4m)
      execb_ecbmm4m(1) = lantip
      call smextf(lincom,amuq(2),pfecb_ecbmm9,
     &ptecb_ecbmm9q,cfecb_ecbmm9q)
      execb_ecbmm9q(1) = lantip
      call smextf(lincom,amlp(1),pfecb_ecbmm17,
     &ptecb_ecbmm17m,cfecb_ecbmm17m)
      execb_ecbmm17m(1) = lantip
      call smextf(loutgo,amlp(2),pfecb_ecbmm33,
     &ptecb_ecbmm33n,cfecb_ecbmm33n)
      execb_ecbmm33n(1) = lprtcl
      call smextf(lincom,amlp(2),pfecb_ecbmm62,
     &ptecb_ecbmm62n,cfecb_ecbmm62n)
