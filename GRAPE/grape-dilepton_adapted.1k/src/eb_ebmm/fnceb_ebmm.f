...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,neb_ebmmextn),
     &pp(neb_ebmmextn,neb_ebmmextn)
...
*     1: initial b mass=amdq(3)
      peeb_ebmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeb_ebmm2(i) = p(i, kperm(2))

*     3: final b mass=amdq(3)
      peeb_ebmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeb_ebmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peeb_ebmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peeb_ebmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neb_ebmmextn
      do 30 i = 1, neb_ebmmextn
...
*=======================================================================
      call kfill_4f(neb_ebmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
