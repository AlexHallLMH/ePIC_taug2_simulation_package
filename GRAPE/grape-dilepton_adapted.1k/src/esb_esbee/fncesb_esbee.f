...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nesb_esbeeextn)
     &,pp(nesb_esbeeextn,nesb_esbeeextn)
...
*     1: initial s-bar mass=amdq(2)
      peesb_esbee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peesb_esbee2(i) = p(i, kperm(2))

*     3: final s-bar mass=amdq(2)
      peesb_esbee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peesb_esbee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peesb_esbee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peesb_esbee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nesb_esbeeextn
      do 30 i = 1, nesb_esbeeextn
...
*=======================================================================
      call kfill_4f(nesb_esbeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
