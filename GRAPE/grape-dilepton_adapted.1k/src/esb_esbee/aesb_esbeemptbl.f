...
* External lines
      call smextf(loutgo,amdq(2),pfesb_esbee2,ptesb_esbee2t,
     &cfesb_esbee2t)
      exesb_esbee2t(1) = lantip
      call smextf(loutgo,amlp(1),pfesb_esbee4,ptesb_esbee4m,
     &cfesb_esbee4m)
      exesb_esbee4m(1) = lantip
      call smextf(lincom,amdq(2),pfesb_esbee9,ptesb_esbee9t,
     &cfesb_esbee9t)
      exesb_esbee9t(1) = lantip
      call smextf(lincom,amlp(1),pfesb_esbee17,ptesb_esbee17m,
     &cfesb_esbee17m)
      exesb_esbee17m(1) = lantip
      call smextf(loutgo,amlp(1),pfesb_esbee33,ptesb_esbee33m,
     &cfesb_esbee33m)
      exesb_esbee33m(1) = lprtcl
      call smextf(lincom,amlp(1),pfesb_esbee62,ptesb_esbee62m,
     &cfesb_esbee62m)
