...
C----- START OF ALEX CONTRIBUTIONS: Declare the common block so a_tau is available
      DOUBLE PRECISION a_tau
      COMMON /TAU_CONFIG/ a_tau

C----- Call the subroutine to read config.txt (executes only once)
      CALL READ_CONFIG

C----- END OF ALEX CONTRIBUTIONS
