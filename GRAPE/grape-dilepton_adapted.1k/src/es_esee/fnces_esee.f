...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nes_eseeextn)
      real*8     pp(nes_eseeextn,nes_eseeextn)
...
*     1: initial s mass=amdq(2)
      pees_esee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      pees_esee2(i) = p(i, kperm(2))

*     3: final s mass=amdq(2)
      pees_esee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      pees_esee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      pees_esee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      pees_esee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nes_eseeextn
      do 30 i = 1, nes_eseeextn
...
*=======================================================================
      call kfill_4f(nes_eseeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
