...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nedb_edbttextn)
      real*8     pp(nedb_edbttextn,nedb_edbttextn)
...
*     1: initial d-bar mass=amdq(1)
      peedb_edbtt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peedb_edbtt2(i) = p(i, kperm(2))

*     3: final d-bar mass=amdq(1)
      peedb_edbtt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peedb_edbtt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peedb_edbtt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peedb_edbtt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nedb_edbttextn
      do 30 i = 1, nedb_edbttextn
...
*=======================================================================
      call kfill_4f(nedb_edbttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
