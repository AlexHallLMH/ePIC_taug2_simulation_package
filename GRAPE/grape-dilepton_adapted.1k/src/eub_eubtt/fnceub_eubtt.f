...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8 xx(mxdim),p(4,neub_eubttextn)
      real*8 pp(neub_eubttextn,neub_eubttextn)
...
*     1: initial u-bar mass=amuq(1)
      peeub_eubtt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeub_eubtt2(i) = p(i, kperm(2))

*     3: final u-bar mass=amuq(1)
      peeub_eubtt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeub_eubtt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peeub_eubtt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peeub_eubtt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neub_eubttextn
      do 30 i = 1, neub_eubttextn
...
*=======================================================================
      call kfill_4f(neub_eubttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
