...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_eXttextn)
      real*8 pp(nep_eXttextn,nep_eXttextn)
...
*     1: initial p mass=amp
      peep_eXtt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_eXtt2(i) = p(i, kperm(2))

*     3: final xxx mass=amp
      peep_eXtt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_eXtt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peep_eXtt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peep_eXtt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_eXttextn
      do 30 i = 1, nep_eXttextn
...
*=======================================================================
      call kfill_4f(nep_eXttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
