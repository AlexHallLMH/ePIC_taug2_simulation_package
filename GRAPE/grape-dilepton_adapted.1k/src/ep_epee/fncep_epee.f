...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_epeeextn)
      real*8     pp(nep_epeeextn,nep_epeeextn)
...
*     1: initial p mass=amp
      peep_epee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_epee2(i) = p(i, kperm(2))

*     3: final p mass=amp
      peep_epee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_epee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peep_epee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peep_epee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_epeeextn
      do 30 i = 1, nep_epeeextn
...
*=======================================================================
      call kfill_4f(nep_epeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
