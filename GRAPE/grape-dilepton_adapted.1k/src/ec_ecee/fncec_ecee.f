...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nec_eceeextn)
     &,pp(nec_eceeextn,nec_eceeextn)
...
*     1: initial c mass=amuq(2)
      peec_ecee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peec_ecee2(i) = p(i, kperm(2))

*     3: final c mass=amuq(2)
      peec_ecee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peec_ecee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peec_ecee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peec_ecee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nec_eceeextn
      do 30 i = 1, nec_eceeextn
...
*=======================================================================
      call kfill_4f(nec_eceeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
