...
* External lines
      call smextf(loutgo,amdq(3),pfebb_ebbee2,
     &ptebb_ebbee2u,cfebb_ebbee2u)
      exebb_ebbee2u(1) = lantip
      call smextf(loutgo,amlp(1),pfebb_ebbee4,
     &ptebb_ebbee4m,cfebb_ebbee4m)
      exebb_ebbee4m(1) = lantip
      call smextf(lincom,amdq(3),pfebb_ebbee9,
     &ptebb_ebbee9u,cfebb_ebbee9u)
      exebb_ebbee9u(1) = lantip
      call smextf(lincom,amlp(1),pfebb_ebbee17,
     &ptebb_ebbee17m,cfebb_ebbee17m)
      exebb_ebbee17m(1) = lantip
      call smextf(loutgo,amlp(1),pfebb_ebbee33,
     &ptebb_ebbee33m,cfebb_ebbee33m)
      exebb_ebbee33m(1) = lprtcl
      call smextf(lincom,amlp(1),pfebb_ebbee62,
     &ptebb_ebbee62m,cfebb_ebbee62m)
