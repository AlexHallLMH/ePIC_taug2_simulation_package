...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_epttextn)
      real*8 pp(nep_epttextn,nep_epttextn)
...
*     1: initial p mass=amp
      peep_eptt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_eptt2(i) = p(i, kperm(2))

*     3: final p mass=amp
      peep_eptt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_eptt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peep_eptt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peep_eptt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_epttextn
      do 30 i = 1, nep_epttextn
...
*=======================================================================
      call kfill_4f(nep_epttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
