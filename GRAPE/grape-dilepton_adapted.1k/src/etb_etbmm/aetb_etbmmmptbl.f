...
* External lines
      call smextf(loutgo,amuq(3),pfetb_etbmm2,
     &ptetb_etbmm2r,cfetb_etbmm2r)
      exetb_etbmm2r(1) = lantip
      call smextf(loutgo,amlp(1),pfetb_etbmm4,
     &ptetb_etbmm4m,cfetb_etbmm4m)
      exetb_etbmm4m(1) = lantip
      call smextf(lincom,amuq(3),pfetb_etbmm9,
     &ptetb_etbmm9r,cfetb_etbmm9r)
      exetb_etbmm9r(1) = lantip
      call smextf(lincom,amlp(1),pfetb_etbmm17,
     &ptetb_etbmm17m,cfetb_etbmm17m)
      exetb_etbmm17m(1) = lantip
      call smextf(loutgo,amlp(2),pfetb_etbmm33,
     &ptetb_etbmm33n,cfetb_etbmm33n)
      exetb_etbmm33n(1) = lprtcl
      call smextf(lincom,amlp(2),pfetb_etbmm62,
     &ptetb_etbmm62n,cfetb_etbmm62n)
