...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_epmmextn)
      real*8 pp(nep_epmmextn,nep_epmmextn)
...
*     1: initial p mass=amp
      peep_epmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_epmm2(i) = p(i, kperm(2))

*     3: final p mass=amp
      peep_epmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_epmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peep_epmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peep_epmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_epmmextn
      do 30 i = 1, nep_epmmextn
...
*=======================================================================
      call kfill_4f(nep_epmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
