...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_eXmmextn)
      real*8 pp(nep_eXmmextn,nep_eXmmextn)
...
*     1: initial p mass=amp
      peep_eXmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_eXmm2(i) = p(i, kperm(2))

*     3: final xxx mass=amp
      peep_eXmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_eXmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peep_eXmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peep_eXmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_eXmmextn
      do 30 i = 1, nep_eXmmextn
...
*=======================================================================
      call kfill_4f(nep_eXmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
