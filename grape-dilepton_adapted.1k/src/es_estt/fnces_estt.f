...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nes_esttextn)
     &,pp(nes_esttextn,nes_esttextn)
...
*     1: initial s mass=amdq(2)
      pees_estt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      pees_estt2(i) = p(i, kperm(2))

*     3: final s mass=amdq(2)
      pees_estt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      pees_estt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      pees_estt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      pees_estt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nes_esttextn
      do 30 i = 1, nes_esttextn
...
*=======================================================================
      call kfill_4f(nes_esttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
