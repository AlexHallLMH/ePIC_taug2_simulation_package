...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8 xx(mxdim),p(4,neub_eubeeextn)
      real*8 pp(neub_eubeeextn,neub_eubeeextn)
...
*     1: initial u-bar mass=amuq(1)
      peeub_eubee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeub_eubee2(i) = p(i, kperm(2))

*     3: final u-bar mass=amuq(1)
      peeub_eubee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeub_eubee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peeub_eubee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peeub_eubee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neub_eubeeextn
      do 30 i = 1, neub_eubeeextn
...
*=======================================================================
      call kfill_4f(neub_eubeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
