...
* External lines
      call smextf(loutgo,amuq(1),pfeub_eubee2,pteub_eubee2p,
     & cfeub_eubee2p)
      exeub_eubee2p(1) = lantip
      call smextf(loutgo,amlp(1),pfeub_eubee4,pteub_eubee4m,
     & cfeub_eubee4m)
      exeub_eubee4m(1) = lantip
      call smextf(lincom,amuq(1),pfeub_eubee9,pteub_eubee9p,
     & cfeub_eubee9p)
      exeub_eubee9p(1) = lantip
      call smextf(lincom,amlp(1),pfeub_eubee17,pteub_eubee17m,
     & cfeub_eubee17m)
      exeub_eubee17m(1) = lantip
      call smextf(loutgo,amlp(1),pfeub_eubee33,pteub_eubee33m,
     & cfeub_eubee33m)
      exeub_eubee33m(1) = lprtcl
      call smextf(lincom,amlp(1),pfeub_eubee62,pteub_eubee62m,
     & cfeub_eubee62m)
