...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8 xx(mxdim),p(4,nep_eXeeextn)
      real*8 pp(nep_eXeeextn,nep_eXeeextn)
...
*     1: initial p mass=amp
      peep_eXee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peep_eXee2(i) = p(i, kperm(2))

*     3: final xxx mass=amp
      peep_eXee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peep_eXee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peep_eXee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peep_eXee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nep_eXeeextn
      do 30 i = 1, nep_eXeeextn
...
*=======================================================================
      call kfill_4f(nep_eXeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
