...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nebb_ebbeeextn),
     &pp(nebb_ebbeeextn,nebb_ebbeeextn)
...
*     1: initial b-bar mass=amdq(3)
      peebb_ebbee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peebb_ebbee2(i) = p(i, kperm(2))

*     3: final b-bar mass=amdq(3)
      peebb_ebbee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peebb_ebbee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peebb_ebbee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peebb_ebbee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nebb_ebbeeextn
      do 30 i = 1, nebb_ebbeeextn
...
*=======================================================================
      call kfill_4f(nebb_ebbeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
