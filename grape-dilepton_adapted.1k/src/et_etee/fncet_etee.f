...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,net_eteeextn),
     &pp(net_eteeextn,net_eteeextn)
...
*     1: initial t mass=amuq(3)
      peet_etee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peet_etee2(i) = p(i, kperm(2))

*     3: final t mass=amuq(3)
      peet_etee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peet_etee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peet_etee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peet_etee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, net_eteeextn
      do 30 i = 1, net_eteeextn
...
*=======================================================================
      call kfill_4f(net_eteeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
