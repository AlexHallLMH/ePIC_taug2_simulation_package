...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,neb_ebeeextn),
     &pp(neb_ebeeextn,neb_ebeeextn)
...
*     1: initial b mass=amdq(3)
      peeb_ebee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeb_ebee2(i) = p(i, kperm(2))

*     3: final b mass=amdq(3)
      peeb_ebee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeb_ebee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peeb_ebee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peeb_ebee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neb_ebeeextn
      do 30 i = 1, neb_ebeeextn
...
*=======================================================================
      call kfill_4f(neb_ebeeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
