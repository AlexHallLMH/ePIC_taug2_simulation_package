...
* External lines
      call smextf(loutgo,amuq(2),pfecb_ecbee2,
     &ptecb_ecbee2q,cfecb_ecbee2q)
      execb_ecbee2q(1) = lantip
      call smextf(loutgo,amlp(1),pfecb_ecbee4,
     &ptecb_ecbee4m,cfecb_ecbee4m)
      execb_ecbee4m(1) = lantip
      call smextf(lincom,amuq(2),pfecb_ecbee9,
     &ptecb_ecbee9q,cfecb_ecbee9q)
      execb_ecbee9q(1) = lantip
      call smextf(lincom,amlp(1),pfecb_ecbee17,
     &ptecb_ecbee17m,cfecb_ecbee17m)
      execb_ecbee17m(1) = lantip
      call smextf(loutgo,amlp(1),pfecb_ecbee33,
     &ptecb_ecbee33m,cfecb_ecbee33m)
      execb_ecbee33m(1) = lprtcl
      call smextf(lincom,amlp(1),pfecb_ecbee62,
     &ptecb_ecbee62m,cfecb_ecbee62m)
