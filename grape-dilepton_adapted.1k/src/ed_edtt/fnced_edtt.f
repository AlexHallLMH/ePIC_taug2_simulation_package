...
*     1: initial d mass=amdq(1)
      peed_edtt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peed_edtt2(i) = p(i, kperm(2))

*     3: final d mass=amdq(1)
      peed_edtt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peed_edtt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peed_edtt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peed_edtt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, ned_edttextn
      do 30 i = 1, ned_edttextn
...
*=======================================================================
      call kfill_4f(ned_edttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
