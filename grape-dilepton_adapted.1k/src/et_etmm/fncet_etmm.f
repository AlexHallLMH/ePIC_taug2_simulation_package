...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,net_etmmextn),
     &pp(net_etmmextn,net_etmmextn)
...
*     1: initial t mass=amuq(3)
      peet_etmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peet_etmm2(i) = p(i, kperm(2))

*     3: final t mass=amuq(3)
      peet_etmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peet_etmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peet_etmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peet_etmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, net_etmmextn
      do 30 i = 1, net_etmmextn
...
*=======================================================================
      call kfill_4f(net_etmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
