...
* External lines
      call smextf(loutgo,amuq(1),pfeub_eubmm2,pteub_eubmm2p,
     & cfeub_eubmm2p)
      exeub_eubmm2p(1) = lantip
      call smextf(loutgo,amlp(1),pfeub_eubmm4,pteub_eubmm4m,
     & cfeub_eubmm4m)
      exeub_eubmm4m(1) = lantip
      call smextf(lincom,amuq(1),pfeub_eubmm9,pteub_eubmm9p,
     & cfeub_eubmm9p)
      exeub_eubmm9p(1) = lantip
      call smextf(lincom,amlp(1),pfeub_eubmm17,pteub_eubmm17m,
     & cfeub_eubmm17m)
      exeub_eubmm17m(1) = lantip
      call smextf(loutgo,amlp(2),pfeub_eubmm33,pteub_eubmm33n,
     & cfeub_eubmm33n)
      exeub_eubmm33n(1) = lprtcl
      call smextf(lincom,amlp(2),pfeub_eubmm62,pteub_eubmm62n,
     & cfeub_eubmm62n)
