...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8 xx(mxdim),p(4,neub_eubmmextn)
      real*8 pp(neub_eubmmextn,neub_eubmmextn)
...
*     1: initial u-bar mass=amuq(1)
      peeub_eubmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeub_eubmm2(i) = p(i, kperm(2))

*     3: final u-bar mass=amuq(1)
      peeub_eubmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeub_eubmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peeub_eubmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peeub_eubmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neub_eubmmextn
      do 30 i = 1, neub_eubmmextn
...
*=======================================================================
      call kfill_4f(neub_eubmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
