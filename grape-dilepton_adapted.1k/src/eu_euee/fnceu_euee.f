...
*     1: initial u mass=amuq(1)
      peeu_euee1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeu_euee2(i) = p(i, kperm(2))

*     3: final u mass=amuq(1)
      peeu_euee3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeu_euee4(i) = p(i, kperm(4))

*     5: final electron mass=amlp(1)
      peeu_euee5(i) = p(i, kperm(5))

*     6: final positron mass=amlp(1)
      peeu_euee6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neu_eueeextn
      do 30 i = 1, neu_eueeextn
...
*=======================================================================
      call kfill_4f(neu_eueeextn, ndim, x, p, pp, ans*aident)
*=======================================================================
