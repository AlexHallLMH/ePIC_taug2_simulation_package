...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,net_etttextn),
     &pp(net_etttextn,net_etttextn)
...
*     1: initial t mass=amuq(3)
      peet_ettt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peet_ettt2(i) = p(i, kperm(2))

*     3: final t mass=amuq(3)
      peet_ettt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peet_ettt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peet_ettt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peet_ettt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, net_etttextn
      do 30 i = 1, net_etttextn
...
*=======================================================================
      call kfill_4f(net_etttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
