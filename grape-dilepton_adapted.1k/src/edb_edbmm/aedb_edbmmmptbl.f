...
* External lines
      call smextf(loutgo,amdq(1),pfedb_edbmm2,ptedb_edbmm2s,
     &               cfedb_edbmm2s)
      exedb_edbmm2s(1) = lantip
      call smextf(loutgo,amlp(1),pfedb_edbmm4,ptedb_edbmm4m,
     &               cfedb_edbmm4m)
      exedb_edbmm4m(1) = lantip
      call smextf(lincom,amdq(1),pfedb_edbmm9,ptedb_edbmm9s,
     &               cfedb_edbmm9s)
      exedb_edbmm9s(1) = lantip
      call smextf(lincom,amlp(1),pfedb_edbmm17,ptedb_edbmm17m,
     &               cfedb_edbmm17m)
      exedb_edbmm17m(1) = lantip
      call smextf(loutgo,amlp(2),pfedb_edbmm33,ptedb_edbmm33n,
     &               cfedb_edbmm33n)
      exedb_edbmm33n(1) = lprtcl
      call smextf(lincom,amlp(2),pfedb_edbmm62,ptedb_edbmm62n,
     &               cfedb_edbmm62n)
