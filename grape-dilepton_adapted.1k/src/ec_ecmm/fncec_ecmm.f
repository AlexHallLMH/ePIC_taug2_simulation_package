...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nec_ecmmextn)
     &,pp(nec_ecmmextn,nec_ecmmextn)
...
*     1: initial c mass=amuq(2)
      peec_ecmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peec_ecmm2(i) = p(i, kperm(2))

*     3: final c mass=amuq(2)
      peec_ecmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peec_ecmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peec_ecmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peec_ecmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nec_ecmmextn
      do 30 i = 1, nec_ecmmextn
...
*=======================================================================
      call kfill_4f(nec_ecmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
