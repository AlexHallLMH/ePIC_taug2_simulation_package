...
*     1: initial u mass=amuq(1)
      peeu_eutt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peeu_eutt2(i) = p(i, kperm(2))

*     3: final u mass=amuq(1)
      peeu_eutt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peeu_eutt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peeu_eutt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peeu_eutt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, neu_euttextn
      do 30 i = 1, neu_euttextn
...
*=======================================================================
      call kfill_4f(neu_euttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
