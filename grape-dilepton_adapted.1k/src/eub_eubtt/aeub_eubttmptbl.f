...
* External lines
      call smextf(loutgo,amuq(1),pfeub_eubtt2,pteub_eubtt2p,
     & cfeub_eubtt2p)
      exeub_eubtt2p(1) = lantip
      call smextf(loutgo,amlp(1),pfeub_eubtt4,pteub_eubtt4m,
     & cfeub_eubtt4m)
      exeub_eubtt4m(1) = lantip
      call smextf(lincom,amuq(1),pfeub_eubtt9,pteub_eubtt9p,
     & cfeub_eubtt9p)
      exeub_eubtt9p(1) = lantip
      call smextf(lincom,amlp(1),pfeub_eubtt17,pteub_eubtt17m,
     & cfeub_eubtt17m)
      exeub_eubtt17m(1) = lantip
      call smextf(loutgo,amlp(3),pfeub_eubtt33,pteub_eubtt33o,
     & cfeub_eubtt33o)
      exeub_eubtt33o(1) = lprtcl
      call smextf(lincom,amlp(3),pfeub_eubtt62,pteub_eubtt62o,
     & cfeub_eubtt62o)
