...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nes_esmmextn)
     &,pp(nes_esmmextn,nes_esmmextn)
...
*     1: initial s mass=amdq(2)
      pees_esmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      pees_esmm2(i) = p(i, kperm(2))

*     3: final s mass=amdq(2)
      pees_esmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      pees_esmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      pees_esmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      pees_esmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nes_esmmextn
      do 30 i = 1, nes_esmmextn
...
*=======================================================================
      call kfill_4f(nes_esmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
