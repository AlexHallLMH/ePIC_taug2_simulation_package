...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nesb_esbmmextn)
     &,pp(nesb_esbmmextn,nesb_esbmmextn)
...
*     1: initial s-bar mass=amdq(2)
      peesb_esbmm1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peesb_esbmm2(i) = p(i, kperm(2))

*     3: final s-bar mass=amdq(2)
      peesb_esbmm3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peesb_esbmm4(i) = p(i, kperm(4))

*     5: final muon mass=amlp(2)
      peesb_esbmm5(i) = p(i, kperm(5))

*     6: final anti-muon mass=amlp(2)
      peesb_esbmm6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nesb_esbmmextn
      do 30 i = 1, nesb_esbmmextn
...
*=======================================================================
      call kfill_4f(nesb_esbmmextn, ndim, x, p, pp, ans*aident)
*=======================================================================
