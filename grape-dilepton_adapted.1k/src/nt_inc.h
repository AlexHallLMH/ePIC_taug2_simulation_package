...
C        parameter (cnextn ='6')   !!!
      double precision  vec_px, vec_py, vec_pz, vec_e, vec_m
       common /mNT_VEC/  vec_px, vec_py, vec_pz, vec_e, vec_m
      character*(*) NT_VEC
     ...
     &                        ,pm(N_max)
       common /mNT_PYTHIA/ Npy, px, py, pz, pe, pm, kf, sta, mot
      character*(*) PYTHIA
      parameter (   PYTHIA =
     &                       'npy[0,'//cN_max//']:i'
     &                    //',px(npy):r*4'
