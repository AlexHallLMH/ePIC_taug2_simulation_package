...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nec_ecttextn)
     &,pp(nec_ecttextn,nec_ecttextn)
...
*     1: initial c mass=amuq(2)
      peec_ectt1(i) = p(i, kperm(1))

*     2: initial positron mass=amlp(1)
      peec_ectt2(i) = p(i, kperm(2))

*     3: final c mass=amuq(2)
      peec_ectt3(i) = p(i, kperm(3))

*     4: final positron mass=amlp(1)
      peec_ectt4(i) = p(i, kperm(4))

*     5: final tau mass=amlp(3)
      peec_ectt5(i) = p(i, kperm(5))

*     6: final anti-tau mass=amlp(3)
      peec_ectt6(i) = p(i, kperm(6))
...
*-----------------------------------------------------------------------
      ...
      do 30 j = 1, nec_ecttextn
      do 30 i = 1, nec_ecttextn
...
*=======================================================================
      call kfill_4f(nec_ecttextn, ndim, x, p, pp, ans*aident)
*=======================================================================
