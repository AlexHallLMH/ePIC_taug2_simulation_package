/** 
 ...
 @brief Description of Tauola Interface in C++.  WARNING for Doxygen sub-pages: Namespaces, Data Structures, Files, Directorises. All describe the development  version. For the release of particular choice, its doxygen documentation is included in the corresponding distribution tar-ball. 
 ...
 - <a href="resources/TAUOLA.1.1.8/Tauola_interface_design.1.1.8.pdf">Tauola_interface_design.1.1.8.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.8/TAUOLA.1.1.8-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.8/TAUOLA.1.1.8.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.8/svn_info_tauola.1.1.8.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.8/changelog.1.1.8.txt">changelog.txt</a>, for Tauspinner technical documentation see also arXiv:1802.05459.

 <b>IMPORTANT NOTE:</b> Starting from release v1.1.8 we have added HepMC3 support (HepMC3 is avialble on the official <a href="https://hepmc.web.cern.ch/hepmc/">HepMC website</a>).
 HEPEVT and HepMC libraries are now separated, which means <b>changes to the list of linked libraries are necessary</b>.
 ...
 - <a href="resources/TAUOLA.development.version/Tauola_interface_design.development.version.pdf">Tauola_interface_design.pdf</a> full software documentation.
 - <a href="resources/TAUOLA.development.version/TAUOLA.development.version-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.development.version/TAUOLA.development.version.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>) tarball and its <a href="resources/TAUOLA.development.version/svn_info_tauola.development.version.txt">revision info</a> SVN tag, tarball creation date/time, etc.
For updates  with respect to release 1.0 see <a href="resources/TAUOLA.development.version/changelog.development.version.txt">changelog.txt</a>, for Tauspinner technical documentation on electroweak corrections see also arXiv:1808.08616 .
 ...
 - <a href="resources/TAUOLA.1.0.tar.gz">TAUOLA source code </a> tarball.

 The source code and documentation for release 1.0.2
 - <a href="resources/TAUOLA.1.0.2/Tauola_interface_design.1.0.2.pdf">Tauola_interface_design.1.0.2.pdf</a> full software documentation includes updates with respect to 
the preprint version.
 - <a href="resources/TAUOLA.1.0.2/TAUOLA.1.0.2-LHC.tar.gz">TAUOLA source code for LHC</a>
(or <a href="resources/TAUOLA.1.0.2/TAUOLA.1.0.2.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.0.2/svn_info_tauola.1.0.2.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.0.2/changelog.1.0.2.txt">changelog.txt</a>.

 The source code and documentation for release 1.0.4
 - <a href="resources/TAUOLA.1.0.4/Tauola_interface_design.1.0.4.pdf">Tauola_interface_design.1.0.4.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.0.4/TAUOLA.1.0.4-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.0.4/TAUOLA.1.0.4.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.0.4/svn_info_tauola.1.0.4.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.0.4/changelog.1.0.4.txt">changelog.txt</a>.

 The source code and documentation for release 1.0.5
 - <a href="resources/TAUOLA.1.0.5/Tauola_interface_design.1.0.5.pdf">Tauola_interface_design.1.0.5.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.0.5/TAUOLA.1.0.5-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.0.5/TAUOLA.1.0.5.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.0.5/svn_info_tauola.1.0.5.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.0.5/changelog.1.0.5.txt">changelog.txt</a>.

 The source code and documentation for release 1.0.6
 - <a href="resources/TAUOLA.1.0.6/Tauola_interface_design.1.0.6.pdf">Tauola_interface_design.1.0.6.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.0.6/TAUOLA.1.0.6-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.0.6/TAUOLA.1.0.6.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.0.6/svn_info_tauola.1.0.6.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.0.6/changelog.1.0.6.txt">changelog.txt</a>.

 The source code and documentation for release 1.0.7
 - <a href="resources/TAUOLA.1.0.7/Tauola_interface_design.1.0.7.pdf">Tauola_interface_design.1.0.7.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.0.7/TAUOLA.1.0.7-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.0.7/TAUOLA.1.0.7.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.0.7/svn_info_tauola.1.0.7.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.0.7/changelog.1.0.7.txt">changelog.txt</a>.

 The source code and documentation for release 1.1.0
 - <a href="resources/TAUOLA.1.1.0/Tauola_interface_design.1.1.0.pdf">Tauola_interface_design.1.1.0.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.0/TAUOLA.1.1.0-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.0/TAUOLA.1.1.0.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.0/svn_info_tauola.1.1.0.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.1.0/changelog.1.1.0.txt">changelog.txt</a>. Starting from this version  <a href="http://arxiv.org/abs/1201.0117">TauSpinner </a>was merged into TAUOLA source code.

 The source code and documentation for release 1.1.1
 - <a href="resources/TAUOLA.1.1.1/Tauola_interface_design.1.1.1.pdf">Tauola_interface_design.1.1.1.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.1/TAUOLA.1.1.1-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.1/TAUOLA.1.1.1.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.1/svn_info_tauola.1.1.1.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.1.1/changelog.1.1.1.txt">changelog.txt</a>.

- \b NOTE: this version was erroneously made public for three days (Nov 20-22) and lacks numerical protecting code against rounding errors for TauSpinner operation on events with bremsstrahlung in leptonic decays.
Version 1.1.1a should be used instead.
For the period of time Nov 23 - Nov 27 this (1.1.1) version number was attributed to the code of version 1.1.1a but svn label was not updated at that time.

 The source code and documentation for release 1.1.1a
 - <a href="resources/TAUOLA.1.1.1a/Tauola_interface_design.1.1.1a.pdf">Tauola_interface_design.1.1.1a.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.1a/TAUOLA.1.1.1a-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.1a/TAUOLA.1.1.1a.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.1a/svn_info_tauola.1.1.1a.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates  with respect to release 1.0 see <a href="resources/TAUOLA.1.1.1a/changelog.1.1.1a.txt">changelog.txt</a>.

 - \b NOTE: for downloads Nov 20-27 2012 please check note for version 1.1.1.

  The source code and documentation for release 1.1.3
 - <a href="resources/TAUOLA.1.1.3/Tauola_interface_design.1.1.3.pdf">Tauola_interface_design.1.1.3.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.3/TAUOLA.1.1.3-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.3/TAUOLA.1.1.3.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.3/svn_info_tauola.1.1.3.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.3/changelog.1.1.3.txt">changelog.txt</a>.

 The source code and documentation for release 1.1.4
 - <a href="resources/TAUOLA.1.1.4/Tauola_interface_design.1.1.4.pdf">Tauola_interface_design.1.1.4.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.4/TAUOLA.1.1.4-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.4/TAUOLA.1.1.4.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.4/svn_info_tauola.1.1.4.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.4/changelog.1.1.4.txt">changelog.txt</a>.

 The source code and documentation for release 1.1.5
 - <a href="resources/TAUOLA.1.1.5/Tauola_interface_design.1.1.5.pdf">Tauola_interface_design.1.1.5.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.5/TAUOLA.1.1.5-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.5/TAUOLA.1.1.5.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.5/svn_info_tauola.1.1.5.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.5/changelog.1.1.5.txt">changelog.txt</a>.

 The source code and documentation for Tauola release 1.1.6  (and of TauSpinner release 2.0.0)
 - <a href="resources/TAUOLA.1.1.6/Tauola_interface_design.1.1.6.pdf">Tauola_interface_design.1.1.6.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.6/TAUOLA.1.1.6-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.6/TAUOLA.1.1.6.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.6/svn_info_tauola.1.1.6.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.6/changelog.1.1.6.txt">changelog.txt</a>.

 The source code and documentation for Tauola release 1.1.6b  (and of TauSpinner release 2.0.1) 
 - <a href="resources/TAUOLA.1.1.6b/Tauola_interface_design.1.1.6b.pdf">Tauola_interface_design.1.1.6b.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.6b/TAUOLA.1.1.6b-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.6b/TAUOLA.1.1.6b.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.6b/svn_info_tauola.1.1.6b.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.6b/changelog.1.1.6b.txt">changelog.txt</a>.

 The source code and documentation for Tauola release 1.1.6c  (and of TauSpinner release 2.0.3) 
 - <a href="resources/TAUOLA.1.1.6c/Tauola_interface_design.1.1.6c.pdf">Tauola_interface_design.1.1.6c.pdf</a> full software documentation includes updates with respect to
the preprint version.
 - <a href="resources/TAUOLA.1.1.6c/TAUOLA.1.1.6c-LHC.tar.gz">TAUOLA source code for the LHC</a>
(or <a href="resources/TAUOLA.1.1.6c/TAUOLA.1.1.6c.tar.gz">TAUOLA source code with full TAUOLA FORTRAN</a>
 enabling changes of code/models for tau decay hadronic currents)
tarball and its <a href="resources/TAUOLA.1.1.6c/svn_info_tauola.1.1.6c.txt">revision info</a> SVN tag, tarball
creation date/time, etc. For updates with respect to release 1.0 see <a href="resources/TAUOLA.1.1.6c/changelog.1.1.6c.txt">changelog.txt</a>.
 - Note: on some platforms the cpp pre-compiler which we use for archiving versions of fortran add into the code gnu licence in c++ comment format. This issue started with gcc 4.8.2. It has been fixed in new release.
 - Solution: in TAUOLA/make.inc set: CPPFLAGS= -C -P -traditional-cpp -nostdinc
...
- <a href="http://photospp.web.cern.ch/">
PHOTOS C++</a> official webpage.
 ...
 you may find <a href="resources/doxygen/README-NO-CONFIG.txt">README-NO-CONFIG.txt</a> useful.
...
the documentation.
 - <a href="resources/pythia_event.pdf">example of a pythia event</a> with 
