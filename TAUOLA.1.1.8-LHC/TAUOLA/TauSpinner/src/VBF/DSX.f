...
c ---------------------   subprocesses initiated by d sbar:  DSX      21.10.2015
 
      SUBROUTINE  DSX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
 
      INTEGER I3,I4,   H1,H2,   KEY
      REAL*8 P(0:3,6), ANS, ANS1,ANS2,ANS3,ANS4,ANS5

C      I3=0,2,3 OR 4             I4=0,-2,-3 OR -4

      ANS=0.D0

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL DSX_UUX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-4) CALL DSX_UCX_H(P,H1,H2,ANS)
         IF(I3.EQ.1 .AND. I4.EQ.-3) CAll DSX_DSX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-2) CALL DSX_CUX_H(P,H1,H2,ANS)
	 IF(I3.EQ.4 .AND. I4.EQ.-4) CALL DSX_CCX_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL DSX_UUX_H(P,H1,H2,ANS1)
                CALL DSX_UCX_H(P,H1,H2,ANS2)
                CALL DSX_DSX_H(P,H1,H2,ANS3)
                CALL DSX_CUX_H(P,H1,H2,ANS4)
		CALL DSX_CCX_H(P,H1,H2,ANS5)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
          IF(I3.EQ.2 .AND. I4.EQ.-2) CALL DSX_UUX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.2 .AND. I4.EQ.-4) CALL DSX_UCX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.1 .AND. I4.EQ.-3) CAll DSX_DSX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.4 .AND. I4.EQ.-2) CALL DSX_CUX_NOH(P,H1,H2,ANS)
 	  IF(I3.EQ.4 .AND. I4.EQ.-4) CALL DSX_CCX_NOH(P,H1,H2,ANS)
             IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                 CALL DSX_UUX_NOH(P,H1,H2,ANS1)
                 CALL DSX_UCX_NOH(P,H1,H2,ANS2)
                 CALL DSX_DSX_NOH(P,H1,H2,ANS3)
                 CALL DSX_CUX_NOH(P,H1,H2,ANS4)
 		 CALL DSX_CCX_NOH(P,H1,H2,ANS5)
                 ANS=ANS1+ANS2+ANS3+ANS4+ANS5
...
C ----- begin subprocesses  DSX->jjH  with Higgs->tautau

      SUBROUTINE DSX_UUX_H(P,H1,H2,ANS)
C
C     
...
C     
C     Process: d s~ > u u~ h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_UUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_UUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_101,MW,WW,W(1,3))
...
c==========================================
      ...
      SUBROUTINE DSX_UCX_H(P,H1,H2,ANS)
C
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > u c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_UCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_UCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C===============================================
      ...
      SUBROUTINE DSX_DSX_H(P,H1,H2,ANS)
C
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_DSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_DSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C======================================== 
      ...
      SUBROUTINE DSX_CUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > c u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_CUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_CUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      MATRIX_DSX_CUX_H=MATRIX
      ENDIF
      ENDIF
      END


      SUBROUTINE DSX_CCX_H(P,H1,H2,ANS)
C
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > c c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_CCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_CCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
	  ...
	  MATRIX_DSX_CCX_H=MATRIX
	  ENDIF
	  ENDIF
	  END

C  ---  end of subprocess DSX->jjH, H->tautau

C ----- begin subprocesses DSX->jjtautau, no Higgs

      SUBROUTINE DSX_UUX_NOH(P,H1,H2,ANS)
C     
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > u u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_101,MW,WW,W(1,8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_1(W(1,2),W(1,7),GC_101,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      MATRIX_DSX_UUX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE DSX_UCX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > u c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_UCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_UCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DSX_UCX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END

      SUBROUTINE DSX_DSX_NOH(P,H1,H2,ANS)
C       
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_DSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_DSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,4),W(1,2),GC_1,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,4),W(1,2),GC_50,GC_58,MZ,WZ,W(1,11))
C     Amplitude(s) for diagram number 3
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,2),W(1,7),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 9
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,2),W(1,12),GC_1,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,4),W(1,9),W(1,7),GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,7),GC_50,GC_58,AMP(16))
      CALL FFV2_3_1(W(1,2),W(1,10),GC_50,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,4),W(1,6),W(1,12),GC_1,AMP(17))
      CALL FFV2_3_2(W(1,4),W(1,10),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,9),W(1,2),W(1,12),GC_1,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,4),W(1,6),W(1,7),GC_50,GC_58,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,7),GC_50,GC_58,AMP(20))
...
C     Amplitude(s) for diagram number 32
     ...
     $ -1./6.*AMP(27)-1./6.*AMP(28)+AMP(29)+AMP(30)+AMP(31)+AMP(32)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DSX_DSX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE DSX_CUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > c u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_CUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_CUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      SUBROUTINE DSX_CCX_NOH(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d s~ > c c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DSX_CCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DSX_CCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DSX_CCX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END
	  
C  ------- end subprocesses DSX->jjtautau, no Higgs
